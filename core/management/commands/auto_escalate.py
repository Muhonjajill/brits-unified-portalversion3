...
from core.utilss.escalation_rules import escalate_ticket, is_within_working_hours
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Only process tickets within working hours
        if not is_within_working_hours():
            self.stdout.write("⚠️ Escalation process skipped because it's outside of working hours.")
            return
